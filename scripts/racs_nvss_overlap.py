...
# %%
# five brightest RACS sources with no NVSS match
tab = xmatch.get_crossmatch_table()
no_match = tab['source_idx_B'] == -1
no_match_tab = tab[no_match]
no_match_tab.rename_column('source_name_A', 'source_name')
...
no_match_full.sort('total_flux_source', reverse=True)
print(no_match_full[:5]['source_name', 'total_flux_source'])
